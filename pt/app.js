...
demotext.position.set(875, 35);
app.stage.addChild(demotext);

const notetext = new PIXI.Text(
    'Nota: Pressione este quadrado roxo para voltar à seleção do idioma ->', {
        fontFamily: 'Rubik',
        fontSize: 15,
        fontWeight: 'normal',
        fill: 'white',
...
apphometext.position.set(50, 515);
...
timelinehometext.position.set(265, 530);
...
settingshometext.position.set(705, 530);
