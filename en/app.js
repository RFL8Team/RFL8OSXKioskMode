...
demotext.position.set(930, 35);
app.stage.addChild(demotext);

const notetext = new PIXI.Text(
    'Note: Press this purple square to go back to the language selection ->', {
        fontFamily: 'Rubik',
        fontSize: 20,
        fontWeight: 'normal',
        fill: 'white',
...
timelinehometext.position.set(265, 510);
