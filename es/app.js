...
demotext.position.set(675, 35);
app.stage.addChild(demotext);

const notetext = new PIXI.Text(
    'Nota: Pulse este cuadrado morado para volver a la selección de idioma ->', {
        fontFamily: 'Rubik',
        fontSize: 15,
        fontWeight: 'normal',
        fill: 'white',
...
apphometext.position.set(50, 520);
...
notificationhometext.position.set(482, 525);
...
mediahometext.position.set(700, 310);
...
settingshometext.position.set(705, 520);
